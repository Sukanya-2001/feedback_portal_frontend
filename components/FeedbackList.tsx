...
import { Feedback } from "./MockDatabase";
import {
  Box,
  Typography,
  Avatar,
    ...
    return (
      ...
      >
        ...
        <Typography variant="body2" color="text.secondary">
          Be the first to share your thoughts by filling out the feedback form above!
        </Typography>
      </Paper>
    );
  }
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5 }}>
      <Typography variant="h6" sx={{ fontWeight: 700, mb: 1 }}>
        Reviews & Feedbacks ({feedbacks.length})
      </Typography>
        ...
        >
          <Box sx={{ display: "flex", gap: 2, alignItems: "flex-start" }}>
            ...
            <Box sx={{ flexGrow: 1 }}>
              ...
              <Typography variant="body2" color="text.primary" sx={{ whiteSpace: "pre-line", mb: item.reply ? 2.5 : 0 }}>
                {item.comment}
              </Typography>
